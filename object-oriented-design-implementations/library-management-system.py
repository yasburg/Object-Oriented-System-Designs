...
class Member(Account):
    ...
    def renew_book_item(self, book_item):
        ...
        if book_reservation and book_reservation.get_member_id() != self.get_member_id():
            print("self book is reserved by another member")
...
class BookItem(Book):
    def __init__(self, barcode, is_reference_only, borrowed, due_date, price, book_format, status, date_of_purchase,
                 publication_date, placed_at, ISBN, title, subject, publisher, language, number_of_pages):
